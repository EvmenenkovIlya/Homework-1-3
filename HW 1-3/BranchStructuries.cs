...
namespace HW_1_3
{
    ...
    {
        /* 1. Пользователь вводит 2 числа (A и B). Если A>B, подсчитать A+B, 
        ...
        /* 2. Пользователь вводит 2 числа(X и Y). Определить какой четверти принадлежит точка 
        * с координатами(X, Y).*/
        ...
        /* 3. Пользователь вводит 3 числа(A, B и С).
